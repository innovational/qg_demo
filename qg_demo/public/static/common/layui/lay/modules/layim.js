...
layui.define(['layer', 'laytpl', 'upload'], function(exports){
  ...
  var layimClose, popmin = function(content){
    ...
    return layer.open({
      ...
      ,offset: 'rb'
      ,resize: false
      ,content: '<img src="'+ (cache.mine.avatar||(layui.cache.dir+'css/pc/layim/skin/logo.jpg')) +'"><span>'+ (content||cache.base.title||'我的汇聊') +'</span>'
  ...
  var anim = 'layui-anim-upbit', events = {
    ...
    ,about: function(){
      /*layer.alert('版本： '+ v + '<br>版权所有：<a href="http://layim.layui.com" target="_blank">layim.layui.com</a>', {
		...
		var html='<style>.menu_tool{} .menu_tool h1{text-align: center;height: 50px;line-height: 50px;border-bottom:1px solid #c0c0c0;}</style>' +
            '<a class="menu_tool" href="/index/userzone/index" target="_blank"><h1>进入空间</h1></a>' +
            '<a class="menu_tool" href="/index/findgroup/myGroup" target="_blank"><h1>管理群</h1></a>';
          layer.open({
              type: 1,
              title:'菜单',
