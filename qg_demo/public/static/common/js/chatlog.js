var baseConfig = {
    chat_log_url: '/index/chatlog/detail',
    per_page: '',
};
...
layui.use(['layim', 'laypage'], function(){
    ...
    $.getJSON(baseConfig.chat_log_url + param + '&flag=1', function(res){
        if(1 == res.code){
            var page = Math.ceil(res.data/baseConfig.per_page);
...
function getLog($, laytpl, laypage, param, curr){
    $.getJSON(baseConfig.chat_log_url + param +"&page="+ curr, function(res){
        if(1 == res.code){
